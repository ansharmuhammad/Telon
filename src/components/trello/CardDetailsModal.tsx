...
export const CardDetailsModal = (props: CardDetailsModalProps) => {
  ...
  const status = isCompleted ? { text: 'Complete', color: 'bg-green-500/20 text-green-700 dark:text-green-400' } : isOverdue ? { text: 'Overdue', color: 'bg-red-500/20 text-red-700 dark:text-red-400' } : isDueSoon ? { text: 'Due soon', color: 'bg-yellow-500/20 text-yellow-700 dark:text-yellow-400' } : null;
